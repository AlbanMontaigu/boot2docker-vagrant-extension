...
## 18.06.1-ce (2018-10-25)
- BUGFIX: fix missed dk tb extension version update
...
- UPDATE: default backup of terraform 0.11.7, ansible 2.5.2 & rancher cli v2.0.0 images
...
- UPDATE: default backup of terraform 0.11.3, ansible 2.4.3.0 & rancher cli v0.6.7 images
